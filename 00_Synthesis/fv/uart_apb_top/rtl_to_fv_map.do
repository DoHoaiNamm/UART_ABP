...
# Generated on: Fri Apr 24 13:14:05 +07 2026 (Fri Apr 24 06:14:05 UTC 2026)
...
set logfile fv/uart_apb_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/uart_apb_top -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/mnt/CADENCE/DDI_2232/GENUS221/tools.lnx86"
set CDN_SYNTH_ROOT      "/mnt/CADENCE/DDI_2232/GENUS221/tools.lnx86"
set env(CW_DIR) "/mnt/CADENCE/DDI_2232/GENUS221/tools.lnx86/lib/chipware"
set CW_DIR      "/mnt/CADENCE/DDI_2232/GENUS221/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /mnt/CADENCE/DDI_2232/GENUS221/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/mnt/CADENCE/DDI_2232/GENUS221/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/mnt/CADENCE/DDI_2232/GENUS221/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/mnt/CADENCE/DDI_2232/GENUS221/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/mnt/CADENCE/DDI_2232/GENUS221/tools.lnx86/lib/chipware/sim"
}
...
add_search_path . ../libraries -library -both
read_library -liberty -both \
    /home/QUYETDT3/DATN/ver3_UART_APB/00_Synthesis/../libraries/lib/max/slow.lib \
    /home/QUYETDT3/DATN/ver3_UART_APB/00_Synthesis/../libraries/lib/max/pdkIO.lib \
    /home/QUYETDT3/DATN/ver3_UART_APB/00_Synthesis/../libraries/lib/min/fast.lib \
    /home/QUYETDT3/DATN/ver3_UART_APB/00_Synthesis/../libraries/lib/min/pdkIO.lib
...
add_search_path . ../rtl/uart_apb -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/uart_apb/apb_uart_sv.sv ../rtl/uart_apb/top.sv ../rtl/uart_apb/io_generic_fifo.sv ../rtl/uart_apb/uart_dma_handshake.sv ../rtl/uart_apb/uart_interface_block.sv ../rtl/uart_apb/uart_interrupt_ctrl.sv ../rtl/uart_apb/uart_rx.sv ../rtl/uart_apb/uart_tx.sv
elaborate_design -golden -root {uart_apb_top} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/uart_apb_top/fv_map.v.gz
elaborate_design -revised -root {uart_apb_top}
...
#add_name_alias fv/uart_apb_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.uart_apb_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.uart_apb_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.uart_apb_top.rtl.fv_map.rpt
