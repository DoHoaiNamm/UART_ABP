#################################################################################
#
# Created by Genus(TM) Synthesis Solution 22.12-s082_1 on Fri Apr 24 13:14:23 +07 2026
#
#################################################################################

## library_sets
create_library_set -name ls_of_ld_slow \
    -timing { /home/QUYETDT3/DATN/ver3_UART_APB/libraries/lib/max/slow.lib \
              /home/QUYETDT3/DATN/ver3_UART_APB/libraries/lib/max/pdkIO.lib }
create_library_set -name ls_of_ld_fast \
    -timing { /home/QUYETDT3/DATN/ver3_UART_APB/libraries/lib/min/fast.lib \
              /home/QUYETDT3/DATN/ver3_UART_APB/libraries/lib/min/pdkIO.lib }
...
create_constraint_mode -name default_emulate_constraint_mode \
    -sdc_files { outputs/uart_apb_top_innovus/cmn/uart_apb_top.mmmc/modes/default_emulate_constraint_mode/default_emulate_constraint_mode.sdc.gz }
