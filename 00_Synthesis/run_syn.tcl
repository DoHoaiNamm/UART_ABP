...
set DESIGN uart_apb_top
set GEN_EFF medium
set MAP_OPT_EFF high
set RTL_DIR ../rtl/uart_apb
...
read_hdl -sv [list \
    $RTL_DIR/apb_uart_sv.sv \
    $RTL_DIR/top.sv \
    $RTL_DIR/io_generic_fifo.sv \
    $RTL_DIR/uart_dma_handshake.sv \
    $RTL_DIR/uart_interface_block.sv \
    $RTL_DIR/uart_interrupt.sv \
    $RTL_DIR/uart_interrupt_ctrl.sv \
    $RTL_DIR/uart_rx.sv \
    $RTL_DIR/uart_tx.sv \
]
